...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:55.473Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.CeCostCategoryRuleRuleAndCostCategory")
@software.amazon.jsii.Jsii.Proxy(CeCostCategoryRuleRuleAndCostCategory.Jsii$Proxy.class)
public interface CeCostCategoryRuleRuleAndCostCategory extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CeCostCategoryRuleRuleAndCostCategory}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CeCostCategoryRuleRuleAndCostCategory}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CeCostCategoryRuleRuleAndCostCategory> {
        java.lang.String key;
        java.util.List<java.lang.String> matchOptions;
        java.util.List<java.lang.String> values;

        /**
         * Sets the value of {@link CeCostCategoryRuleRuleAndCostCategory#getKey}
        ...
        /**
         * Sets the value of {@link CeCostCategoryRuleRuleAndCostCategory#getMatchOptions}
        ...
        /**
         * Sets the value of {@link CeCostCategoryRuleRuleAndCostCategory#getValues}
         ...
         * @return a new instance of {@link CeCostCategoryRuleRuleAndCostCategory}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CeCostCategoryRuleRuleAndCostCategory build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CeCostCategoryRuleRuleAndCostCategory}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CeCostCategoryRuleRuleAndCostCategory {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.CeCostCategoryRuleRuleAndCostCategory"));
        ...
        public final boolean equals(final Object o) {
            ...
            CeCostCategoryRuleRuleAndCostCategory.Jsii$Proxy that = (CeCostCategoryRuleRuleAndCostCategory.Jsii$Proxy) o;
