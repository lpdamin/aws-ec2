...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:47.130Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.CeCostCategoryRuleRuleOrCostCategory")
@software.amazon.jsii.Jsii.Proxy(CeCostCategoryRuleRuleOrCostCategory.Jsii$Proxy.class)
public interface CeCostCategoryRuleRuleOrCostCategory extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CeCostCategoryRuleRuleOrCostCategory}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CeCostCategoryRuleRuleOrCostCategory}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CeCostCategoryRuleRuleOrCostCategory> {
        java.lang.String key;
        java.util.List<java.lang.String> matchOptions;
        java.util.List<java.lang.String> values;

        /**
         * Sets the value of {@link CeCostCategoryRuleRuleOrCostCategory#getKey}
        ...
        /**
         * Sets the value of {@link CeCostCategoryRuleRuleOrCostCategory#getMatchOptions}
        ...
        /**
         * Sets the value of {@link CeCostCategoryRuleRuleOrCostCategory#getValues}
         ...
         * @return a new instance of {@link CeCostCategoryRuleRuleOrCostCategory}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CeCostCategoryRuleRuleOrCostCategory build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CeCostCategoryRuleRuleOrCostCategory}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CeCostCategoryRuleRuleOrCostCategory {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.CeCostCategoryRuleRuleOrCostCategory"));
        ...
        public final boolean equals(final Object o) {
            ...
            CeCostCategoryRuleRuleOrCostCategory.Jsii$Proxy that = (CeCostCategoryRuleRuleOrCostCategory.Jsii$Proxy) o;
