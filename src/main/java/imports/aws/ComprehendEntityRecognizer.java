 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:47.145Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ComprehendEntityRecognizer")
public class ComprehendEntityRecognizer extends com.hashicorp.cdktf.TerraformResource {

    protected ComprehendEntityRecognizer(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ComprehendEntityRecognizer(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ComprehendEntityRecognizer.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public ComprehendEntityRecognizer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putInputDataConfig(final @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerInputDataConfig value) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerTimeouts value) {
        software.amazon.jsii.Kernel.call(this, "putTimeouts", software.amazon.jsii.NativeType.VOID, new Object[] { java.util.Objects.requireNonNull(value, "value is required") });
    }

    public void putVpcConfig(final @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerVpcConfig value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerInputDataConfigOutputReference getInputDataConfig() {
        return software.amazon.jsii.Kernel.get(this, "inputDataConfig", software.amazon.jsii.NativeType.forClass(imports.aws.ComprehendEntityRecognizerInputDataConfigOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.ComprehendEntityRecognizerTimeoutsOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerVpcConfigOutputReference getVpcConfig() {
        return software.amazon.jsii.Kernel.get(this, "vpcConfig", software.amazon.jsii.NativeType.forClass(imports.aws.ComprehendEntityRecognizerVpcConfigOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.ComprehendEntityRecognizerInputDataConfig getInputDataConfigInput() {
        return software.amazon.jsii.Kernel.get(this, "inputDataConfigInput", software.amazon.jsii.NativeType.forClass(imports.aws.ComprehendEntityRecognizerInputDataConfig.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.ComprehendEntityRecognizerVpcConfig getVpcConfigInput() {
        return software.amazon.jsii.Kernel.get(this, "vpcConfigInput", software.amazon.jsii.NativeType.forClass(imports.aws.ComprehendEntityRecognizerVpcConfig.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ComprehendEntityRecognizer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ComprehendEntityRecognizer> {
        /**
        ...
        private final imports.aws.ComprehendEntityRecognizerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ComprehendEntityRecognizerConfig.Builder();
        }
         ...
         */
        public Builder inputDataConfig(final imports.aws.ComprehendEntityRecognizerInputDataConfig inputDataConfig) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#id ComprehendEntityRecognizer#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param modelKmsKeyId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#model_kms_key_id ComprehendEntityRecognizer#model_kms_key_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#tags ComprehendEntityRecognizer#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#tags_all ComprehendEntityRecognizer#tags_all}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.ComprehendEntityRecognizerTimeouts timeouts) {
         ...
         * <p>
         * @return {@code this}
         * @param versionName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#version_name ComprehendEntityRecognizer#version_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param versionNamePrefix Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#version_name_prefix ComprehendEntityRecognizer#version_name_prefix}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param volumeKmsKeyId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/comprehend_entity_recognizer#volume_kms_key_id ComprehendEntityRecognizer#volume_kms_key_id}. This parameter is required.
         */
         ...
         */
        public Builder vpcConfig(final imports.aws.ComprehendEntityRecognizerVpcConfig vpcConfig) {
            this.config.vpcConfig(vpcConfig);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.ComprehendEntityRecognizer}.
         */
        @Override
        public imports.aws.ComprehendEntityRecognizer build() {
            return new imports.aws.ComprehendEntityRecognizer(
                this.scope,
                this.id,
                this.config.build()
            );
