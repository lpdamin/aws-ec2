...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ComprehendEntityRecognizerInputDataConfigEntityTypesList")
public class ComprehendEntityRecognizerInputDataConfigEntityTypesList extends com.hashicorp.cdktf.ComplexList {

    protected ComprehendEntityRecognizerInputDataConfigEntityTypesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ComprehendEntityRecognizerInputDataConfigEntityTypesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ComprehendEntityRecognizerInputDataConfigEntityTypesList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.ComprehendEntityRecognizerInputDataConfigEntityTypesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.ComprehendEntityRecognizerInputDataConfigEntityTypesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.ComprehendEntityRecognizerInputDataConfigEntityTypes> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
