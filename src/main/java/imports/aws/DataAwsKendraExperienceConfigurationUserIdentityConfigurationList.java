...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsKendraExperienceConfigurationUserIdentityConfigurationList")
public class DataAwsKendraExperienceConfigurationUserIdentityConfigurationList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsKendraExperienceConfigurationUserIdentityConfigurationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsKendraExperienceConfigurationUserIdentityConfigurationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsKendraExperienceConfigurationUserIdentityConfigurationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsKendraExperienceConfigurationUserIdentityConfigurationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
