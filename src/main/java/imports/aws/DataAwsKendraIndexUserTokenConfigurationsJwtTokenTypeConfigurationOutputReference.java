...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference")
public class DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfiguration getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfiguration.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.DataAwsKendraIndexUserTokenConfigurationsJwtTokenTypeConfiguration value) {
