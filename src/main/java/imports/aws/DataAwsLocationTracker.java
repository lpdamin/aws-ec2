...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsLocationTracker")
public class DataAwsLocationTracker extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsLocationTracker(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLocationTracker(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.DataAwsLocationTracker.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsLocationTracker(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsLocationTrackerConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsLocationTracker}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsLocationTracker> {
        /**
        ...
        private final imports.aws.DataAwsLocationTrackerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsLocationTrackerConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/location_tracker#id DataAwsLocationTracker#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/location_tracker#tags DataAwsLocationTracker#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsLocationTracker}.
         */
        @Override
        public imports.aws.DataAwsLocationTracker build() {
            return new imports.aws.DataAwsLocationTracker(
                this.scope,
                this.id,
                this.config.build()
            );
