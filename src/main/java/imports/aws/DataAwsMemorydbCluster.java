 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:55.604Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsMemorydbCluster")
public class DataAwsMemorydbCluster extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsMemorydbCluster(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsMemorydbCluster(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.DataAwsMemorydbCluster.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsMemorydbCluster(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsMemorydbClusterConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsMemorydbClusterClusterEndpointList getClusterEndpoint() {
        return software.amazon.jsii.Kernel.get(this, "clusterEndpoint", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsMemorydbClusterClusterEndpointList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsMemorydbClusterShardsList getShards() {
        return software.amazon.jsii.Kernel.get(this, "shards", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsMemorydbClusterShardsList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getTlsEnabled() {
        return software.amazon.jsii.Kernel.get(this, "tlsEnabled", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsMemorydbCluster}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsMemorydbCluster> {
        /**
        ...
        private final imports.aws.DataAwsMemorydbClusterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsMemorydbClusterConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/memorydb_cluster#name DataAwsMemorydbCluster#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/memorydb_cluster#id DataAwsMemorydbCluster#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/memorydb_cluster#tags DataAwsMemorydbCluster#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsMemorydbCluster}.
         */
        @Override
        public imports.aws.DataAwsMemorydbCluster build() {
            return new imports.aws.DataAwsMemorydbCluster(
                this.scope,
                this.id,
                this.config.build()
            );
