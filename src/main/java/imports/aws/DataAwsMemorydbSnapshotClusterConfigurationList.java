...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:55.613Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsMemorydbSnapshotClusterConfigurationList")
public class DataAwsMemorydbSnapshotClusterConfigurationList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsMemorydbSnapshotClusterConfigurationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsMemorydbSnapshotClusterConfigurationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DataAwsMemorydbSnapshotClusterConfigurationList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsMemorydbSnapshotClusterConfigurationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsMemorydbSnapshotClusterConfigurationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
