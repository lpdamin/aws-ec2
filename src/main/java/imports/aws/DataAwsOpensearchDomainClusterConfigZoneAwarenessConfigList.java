...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsOpensearchDomainClusterConfigZoneAwarenessConfigList")
public class DataAwsOpensearchDomainClusterConfigZoneAwarenessConfigList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsOpensearchDomainClusterConfigZoneAwarenessConfigList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsOpensearchDomainClusterConfigZoneAwarenessConfigList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsOpensearchDomainClusterConfigZoneAwarenessConfigOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsOpensearchDomainClusterConfigZoneAwarenessConfigOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
