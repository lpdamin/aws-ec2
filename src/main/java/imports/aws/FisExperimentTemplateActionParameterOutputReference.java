...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.FisExperimentTemplateActionParameterOutputReference")
public class FisExperimentTemplateActionParameterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected FisExperimentTemplateActionParameterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected FisExperimentTemplateActionParameterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.FisExperimentTemplateActionParameter value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
