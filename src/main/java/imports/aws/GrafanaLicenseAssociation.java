 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:55.682Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.GrafanaLicenseAssociation")
public class GrafanaLicenseAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.GrafanaLicenseAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public GrafanaLicenseAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.GrafanaLicenseAssociationConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.GrafanaLicenseAssociationTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.GrafanaLicenseAssociationTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.GrafanaLicenseAssociationTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.GrafanaLicenseAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.GrafanaLicenseAssociation> {
        /**
        ...
        private final imports.aws.GrafanaLicenseAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.GrafanaLicenseAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/grafana_license_association#id GrafanaLicenseAssociation#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.GrafanaLicenseAssociationTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.GrafanaLicenseAssociation}.
         */
        @Override
        public imports.aws.GrafanaLicenseAssociation build() {
            return new imports.aws.GrafanaLicenseAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
