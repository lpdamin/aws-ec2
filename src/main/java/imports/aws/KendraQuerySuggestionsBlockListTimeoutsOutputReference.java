...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.KendraQuerySuggestionsBlockListTimeoutsOutputReference")
public class KendraQuerySuggestionsBlockListTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected KendraQuerySuggestionsBlockListTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected KendraQuerySuggestionsBlockListTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public KendraQuerySuggestionsBlockListTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.KendraQuerySuggestionsBlockListTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
