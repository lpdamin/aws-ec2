...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.KendraThesaurusSourceS3PathOutputReference")
public class KendraThesaurusSourceS3PathOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.KendraThesaurusSourceS3Path getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.KendraThesaurusSourceS3Path.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.KendraThesaurusSourceS3Path value) {
