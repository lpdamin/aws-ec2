...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.LocationRouteCalculatorTimeoutsOutputReference")
public class LocationRouteCalculatorTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LocationRouteCalculatorTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LocationRouteCalculatorTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public LocationRouteCalculatorTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.LocationRouteCalculatorTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
