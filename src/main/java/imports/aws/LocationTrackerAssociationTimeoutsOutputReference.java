...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.LocationTrackerAssociationTimeoutsOutputReference")
public class LocationTrackerAssociationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LocationTrackerAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LocationTrackerAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public LocationTrackerAssociationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.LocationTrackerAssociationTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
