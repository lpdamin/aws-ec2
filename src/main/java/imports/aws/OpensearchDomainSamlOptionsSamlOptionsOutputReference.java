...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.OpensearchDomainSamlOptionsSamlOptionsOutputReference")
public class OpensearchDomainSamlOptionsSamlOptionsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpensearchDomainSamlOptionsSamlOptionsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpensearchDomainSamlOptionsSamlOptionsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public OpensearchDomainSamlOptionsSamlOptionsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(terraformResource, "terraformResource is required"), java.util.Objects.requireNonNull(terraformAttribute, "terraformAttribute is required") });
    }

    public void putIdp(final @org.jetbrains.annotations.NotNull imports.aws.OpensearchDomainSamlOptionsSamlOptionsIdp value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference getIdp() {
        return software.amazon.jsii.Kernel.get(this, "idp", software.amazon.jsii.NativeType.forClass(imports.aws.OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.OpensearchDomainSamlOptionsSamlOptionsIdp getIdpInput() {
        return software.amazon.jsii.Kernel.get(this, "idpInput", software.amazon.jsii.NativeType.forClass(imports.aws.OpensearchDomainSamlOptionsSamlOptionsIdp.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.OpensearchDomainSamlOptionsSamlOptions getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.OpensearchDomainSamlOptionsSamlOptions.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.OpensearchDomainSamlOptionsSamlOptions value) {
