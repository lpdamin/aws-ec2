...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.TranscribeVocabularyTimeoutsOutputReference")
public class TranscribeVocabularyTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected TranscribeVocabularyTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected TranscribeVocabularyTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public TranscribeVocabularyTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.TranscribeVocabularyTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
