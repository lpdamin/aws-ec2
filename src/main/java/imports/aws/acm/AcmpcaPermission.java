 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:56.026Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.acm.AcmpcaPermission")
public class AcmpcaPermission extends com.hashicorp.cdktf.TerraformResource {

    protected AcmpcaPermission(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AcmpcaPermission(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.acm.AcmpcaPermission.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public AcmpcaPermission(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.acm.AcmpcaPermissionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.acm.AcmpcaPermission}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.acm.AcmpcaPermission> {
        /**
        ...
        private final imports.aws.acm.AcmpcaPermissionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.acm.AcmpcaPermissionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/acmpca_permission#id AcmpcaPermission#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param sourceAccount Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/acmpca_permission#source_account AcmpcaPermission#source_account}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.acm.AcmpcaPermission}.
         */
        @Override
        public imports.aws.acm.AcmpcaPermission build() {
            return new imports.aws.acm.AcmpcaPermission(
                this.scope,
                this.id,
                this.config.build()
            );
