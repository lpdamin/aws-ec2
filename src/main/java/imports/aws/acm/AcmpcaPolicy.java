 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:56.030Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.acm.AcmpcaPolicy")
public class AcmpcaPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected AcmpcaPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AcmpcaPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.acm.AcmpcaPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public AcmpcaPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.acm.AcmpcaPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.acm.AcmpcaPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.acm.AcmpcaPolicy> {
        /**
        ...
        private final imports.aws.acm.AcmpcaPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.acm.AcmpcaPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/acmpca_policy#id AcmpcaPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.acm.AcmpcaPolicy}.
         */
        @Override
        public imports.aws.acm.AcmpcaPolicy build() {
            return new imports.aws.acm.AcmpcaPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
