...
public class DataAwsAcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    protected DataAwsAcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.acm.DataAwsAcmpcaCertificateAuthorityRevocationConfigurationOcspConfiguration value) {
