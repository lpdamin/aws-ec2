...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.backup.BackupFrameworkControlInputParameterOutputReference")
public class BackupFrameworkControlInputParameterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected BackupFrameworkControlInputParameterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected BackupFrameworkControlInputParameterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.backup.BackupFrameworkControlInputParameter value) {
