...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudformation.CloudformationStackSetInstanceOperationPreferencesOutputReference")
public class CloudformationStackSetInstanceOperationPreferencesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudformationStackSetInstanceOperationPreferencesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudformationStackSetInstanceOperationPreferencesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudformationStackSetInstanceOperationPreferencesOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.cloudformation.CloudformationStackSetInstanceOperationPreferences getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.cloudformation.CloudformationStackSetInstanceOperationPreferences.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.cloudformation.CloudformationStackSetInstanceOperationPreferences value) {
