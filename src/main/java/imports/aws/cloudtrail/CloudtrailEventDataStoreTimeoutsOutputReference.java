...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudtrail.CloudtrailEventDataStoreTimeoutsOutputReference")
public class CloudtrailEventDataStoreTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudtrailEventDataStoreTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudtrailEventDataStoreTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudtrailEventDataStoreTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.cloudtrail.CloudtrailEventDataStoreTimeouts value) {
