...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudwatch.CloudwatchMetricStreamStatisticsConfigurationIncludeMetricOutputReference")
public class CloudwatchMetricStreamStatisticsConfigurationIncludeMetricOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudwatchMetricStreamStatisticsConfigurationIncludeMetricOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudwatchMetricStreamStatisticsConfigurationIncludeMetricOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.cloudwatch.CloudwatchMetricStreamStatisticsConfigurationIncludeMetric value) {
