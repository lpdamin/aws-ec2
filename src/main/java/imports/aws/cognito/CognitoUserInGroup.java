...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cognito.CognitoUserInGroup")
public class CognitoUserInGroup extends com.hashicorp.cdktf.TerraformResource {

    protected CognitoUserInGroup(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CognitoUserInGroup(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.cognito.CognitoUserInGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public CognitoUserInGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.cognito.CognitoUserInGroupConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.cognito.CognitoUserInGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.cognito.CognitoUserInGroup> {
        /**
        ...
        private final imports.aws.cognito.CognitoUserInGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.cognito.CognitoUserInGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cognito_user_in_group#id CognitoUserInGroup#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.cognito.CognitoUserInGroup}.
         */
        @Override
        public imports.aws.cognito.CognitoUserInGroup build() {
            return new imports.aws.cognito.CognitoUserInGroup(
                this.scope,
                this.id,
                this.config.build()
            );
