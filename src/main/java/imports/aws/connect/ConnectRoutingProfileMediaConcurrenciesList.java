...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.connect.ConnectRoutingProfileMediaConcurrenciesList")
public class ConnectRoutingProfileMediaConcurrenciesList extends com.hashicorp.cdktf.ComplexList {

    protected ConnectRoutingProfileMediaConcurrenciesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ConnectRoutingProfileMediaConcurrenciesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ConnectRoutingProfileMediaConcurrenciesList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.connect.ConnectRoutingProfileMediaConcurrenciesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.connect.ConnectRoutingProfileMediaConcurrenciesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.connect.ConnectRoutingProfileMediaConcurrencies> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
