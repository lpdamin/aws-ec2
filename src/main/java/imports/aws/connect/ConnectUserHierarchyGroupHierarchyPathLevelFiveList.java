...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:57.859Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.connect.ConnectUserHierarchyGroupHierarchyPathLevelFiveList")
public class ConnectUserHierarchyGroupHierarchyPathLevelFiveList extends com.hashicorp.cdktf.ComplexList {

    protected ConnectUserHierarchyGroupHierarchyPathLevelFiveList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ConnectUserHierarchyGroupHierarchyPathLevelFiveList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ConnectUserHierarchyGroupHierarchyPathLevelFiveList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.connect.ConnectUserHierarchyGroupHierarchyPathLevelFiveOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.connect.ConnectUserHierarchyGroupHierarchyPathLevelFiveOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
