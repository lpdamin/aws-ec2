...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfs")
...
public interface DatasyncLocationFsxOpenzfsFileSystemProtocolNfs extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfsMountOptions getMountOptions();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DatasyncLocationFsxOpenzfsFileSystemProtocolNfs> {
        imports.aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfsMountOptions mountOptions;
         ...
         * @return {@code this}
         */
        public Builder mountOptions(imports.aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfsMountOptions mountOptions) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DatasyncLocationFsxOpenzfsFileSystemProtocolNfs {
        private final imports.aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfsMountOptions mountOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.mountOptions = software.amazon.jsii.Kernel.get(this, "mountOptions", software.amazon.jsii.NativeType.forClass(imports.aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfsMountOptions.class));
        }
        ...
        @Override
        public final imports.aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfsMountOptions getMountOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.datasync.DatasyncLocationFsxOpenzfsFileSystemProtocolNfs"));
