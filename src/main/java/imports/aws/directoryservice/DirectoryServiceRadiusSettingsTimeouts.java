...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:48.439Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directoryservice.DirectoryServiceRadiusSettingsTimeouts")
@software.amazon.jsii.Jsii.Proxy(DirectoryServiceRadiusSettingsTimeouts.Jsii$Proxy.class)
public interface DirectoryServiceRadiusSettingsTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DirectoryServiceRadiusSettingsTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DirectoryServiceRadiusSettingsTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DirectoryServiceRadiusSettingsTimeouts> {
        java.lang.String create;
        java.lang.String update;

        /**
         * Sets the value of {@link DirectoryServiceRadiusSettingsTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DirectoryServiceRadiusSettingsTimeouts#getUpdate}
         ...
         * @return a new instance of {@link DirectoryServiceRadiusSettingsTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DirectoryServiceRadiusSettingsTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DirectoryServiceRadiusSettingsTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DirectoryServiceRadiusSettingsTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directoryservice.DirectoryServiceRadiusSettingsTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DirectoryServiceRadiusSettingsTimeouts.Jsii$Proxy that = (DirectoryServiceRadiusSettingsTimeouts.Jsii$Proxy) o;
