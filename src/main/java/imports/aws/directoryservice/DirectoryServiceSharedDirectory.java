 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:58.314Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directoryservice.DirectoryServiceSharedDirectory")
public class DirectoryServiceSharedDirectory extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directoryservice.DirectoryServiceSharedDirectory.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DirectoryServiceSharedDirectory(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceSharedDirectoryConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTarget(final @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceSharedDirectoryTarget value) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceSharedDirectoryTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceSharedDirectoryTargetOutputReference getTarget() {
        return software.amazon.jsii.Kernel.get(this, "target", software.amazon.jsii.NativeType.forClass(imports.aws.directoryservice.DirectoryServiceSharedDirectoryTargetOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceSharedDirectoryTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.directoryservice.DirectoryServiceSharedDirectoryTimeoutsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.directoryservice.DirectoryServiceSharedDirectoryTarget getTargetInput() {
        return software.amazon.jsii.Kernel.get(this, "targetInput", software.amazon.jsii.NativeType.forClass(imports.aws.directoryservice.DirectoryServiceSharedDirectoryTarget.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.directoryservice.DirectoryServiceSharedDirectory}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directoryservice.DirectoryServiceSharedDirectory> {
        /**
        ...
        private final imports.aws.directoryservice.DirectoryServiceSharedDirectoryConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directoryservice.DirectoryServiceSharedDirectoryConfig.Builder();
        }
         ...
         */
        public Builder target(final imports.aws.directoryservice.DirectoryServiceSharedDirectoryTarget target) {
         ...
         * <p>
         * @return {@code this}
         * @param method Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/directory_service_shared_directory#method DirectoryServiceSharedDirectory#method}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param notes Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/directory_service_shared_directory#notes DirectoryServiceSharedDirectory#notes}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.directoryservice.DirectoryServiceSharedDirectoryTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.directoryservice.DirectoryServiceSharedDirectory}.
         */
        @Override
        public imports.aws.directoryservice.DirectoryServiceSharedDirectory build() {
            return new imports.aws.directoryservice.DirectoryServiceSharedDirectory(
                this.scope,
                this.id,
                this.config.build()
            );
