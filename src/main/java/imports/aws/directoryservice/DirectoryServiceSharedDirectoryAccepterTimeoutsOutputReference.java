...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directoryservice.DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference")
public class DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directoryservice.DirectoryServiceSharedDirectoryAccepterTimeouts value) {
