...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:58.322Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.dlm.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList")
public class DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList extends com.hashicorp.cdktf.ComplexList {

    protected DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.dlm.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.dlm.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.dlm.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopy> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
