...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.dlm.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule")
@software.amazon.jsii.Jsii.Proxy(DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule.Jsii$Proxy.class)
public interface DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule> {
        java.lang.Number interval;
        java.lang.String intervalUnit;

        /**
         * Sets the value of {@link DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule#getInterval}
        ...
        /**
         * Sets the value of {@link DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule#getIntervalUnit}
         ...
         * @return a new instance of {@link DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.dlm.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule"));
        ...
        public final boolean equals(final Object o) {
            ...
            DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule.Jsii$Proxy that = (DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule.Jsii$Proxy) o;
