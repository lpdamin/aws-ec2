...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.dynamodb.DynamodbContributorInsightsTimeouts")
@software.amazon.jsii.Jsii.Proxy(DynamodbContributorInsightsTimeouts.Jsii$Proxy.class)
public interface DynamodbContributorInsightsTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DynamodbContributorInsightsTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DynamodbContributorInsightsTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DynamodbContributorInsightsTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DynamodbContributorInsightsTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DynamodbContributorInsightsTimeouts#getDelete}
         ...
         * @return a new instance of {@link DynamodbContributorInsightsTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DynamodbContributorInsightsTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DynamodbContributorInsightsTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DynamodbContributorInsightsTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.dynamodb.DynamodbContributorInsightsTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DynamodbContributorInsightsTimeouts.Jsii$Proxy that = (DynamodbContributorInsightsTimeouts.Jsii$Proxy) o;
