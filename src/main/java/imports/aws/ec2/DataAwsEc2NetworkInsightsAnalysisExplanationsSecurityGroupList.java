...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2NetworkInsightsAnalysisExplanationsSecurityGroupList")
public class DataAwsEc2NetworkInsightsAnalysisExplanationsSecurityGroupList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsEc2NetworkInsightsAnalysisExplanationsSecurityGroupList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2NetworkInsightsAnalysisExplanationsSecurityGroupList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2NetworkInsightsAnalysisExplanationsSecurityGroupOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2NetworkInsightsAnalysisExplanationsSecurityGroupOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
