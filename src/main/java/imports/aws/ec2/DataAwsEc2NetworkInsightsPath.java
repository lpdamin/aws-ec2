 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:48.624Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2NetworkInsightsPath")
public class DataAwsEc2NetworkInsightsPath extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsEc2NetworkInsightsPath(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2NetworkInsightsPath(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.DataAwsEc2NetworkInsightsPath.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEc2NetworkInsightsPath(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2NetworkInsightsPathConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsEc2NetworkInsightsPath(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public void resetNetworkInsightsPathId() {
        software.amazon.jsii.Kernel.call(this, "resetNetworkInsightsPathId", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2NetworkInsightsPathFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2NetworkInsightsPathFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.DataAwsEc2NetworkInsightsPath}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.DataAwsEc2NetworkInsightsPath> {
        /**
        ...
        private imports.aws.ec2.DataAwsEc2NetworkInsightsPathConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.ec2.DataAwsEc2NetworkInsightsPathFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_network_insights_path#id DataAwsEc2NetworkInsightsPath#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param networkInsightsPathId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_network_insights_path#network_insights_path_id DataAwsEc2NetworkInsightsPath#network_insights_path_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_network_insights_path#tags DataAwsEc2NetworkInsightsPath#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.DataAwsEc2NetworkInsightsPath}.
         */
        @Override
        public imports.aws.ec2.DataAwsEc2NetworkInsightsPath build() {
            return new imports.aws.ec2.DataAwsEc2NetworkInsightsPath(
                this.scope,
                this.id,
        ...
        private imports.aws.ec2.DataAwsEc2NetworkInsightsPathConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ec2.DataAwsEc2NetworkInsightsPathConfig.Builder();
            }
            return this.config;
        }
    }
