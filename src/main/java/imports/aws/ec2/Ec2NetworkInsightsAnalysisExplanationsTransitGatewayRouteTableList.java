...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableList")
public class Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableList extends com.hashicorp.cdktf.ComplexList {

    protected Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.Ec2NetworkInsightsAnalysisExplanationsTransitGatewayRouteTableOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
