...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2NetworkInsightsAnalysisReturnPathComponentsAclRuleList")
public class Ec2NetworkInsightsAnalysisReturnPathComponentsAclRuleList extends com.hashicorp.cdktf.ComplexList {

    protected Ec2NetworkInsightsAnalysisReturnPathComponentsAclRuleList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Ec2NetworkInsightsAnalysisReturnPathComponentsAclRuleList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2NetworkInsightsAnalysisReturnPathComponentsAclRuleOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.Ec2NetworkInsightsAnalysisReturnPathComponentsAclRuleOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
