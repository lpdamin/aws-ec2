 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:59.114Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2TransitGatewayMulticastDomainAssociation")
public class Ec2TransitGatewayMulticastDomainAssociation extends com.hashicorp.cdktf.TerraformResource {

    protected Ec2TransitGatewayMulticastDomainAssociation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Ec2TransitGatewayMulticastDomainAssociation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Ec2TransitGatewayMulticastDomainAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociation> {
        /**
        ...
        private final imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_transit_gateway_multicast_domain_association#id Ec2TransitGatewayMulticastDomainAssociation#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociation}.
         */
        @Override
        public imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociation build() {
            return new imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
