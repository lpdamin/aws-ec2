...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference")
public class Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public Ec2TransitGatewayMulticastDomainAssociationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.Ec2TransitGatewayMulticastDomainAssociationTimeouts value) {
