 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:59.120Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2TransitGatewayMulticastGroupMember")
public class Ec2TransitGatewayMulticastGroupMember extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.Ec2TransitGatewayMulticastGroupMember.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Ec2TransitGatewayMulticastGroupMember(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2TransitGatewayMulticastGroupMemberConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.Ec2TransitGatewayMulticastGroupMember}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.Ec2TransitGatewayMulticastGroupMember> {
        /**
        ...
        private final imports.aws.ec2.Ec2TransitGatewayMulticastGroupMemberConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.Ec2TransitGatewayMulticastGroupMemberConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_transit_gateway_multicast_group_member#id Ec2TransitGatewayMulticastGroupMember#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.Ec2TransitGatewayMulticastGroupMember}.
         */
        @Override
        public imports.aws.ec2.Ec2TransitGatewayMulticastGroupMember build() {
            return new imports.aws.ec2.Ec2TransitGatewayMulticastGroupMember(
                this.scope,
                this.id,
                this.config.build()
            );
