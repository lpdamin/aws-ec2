...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.LaunchTemplateInstanceRequirementsNetworkInterfaceCount")
@software.amazon.jsii.Jsii.Proxy(LaunchTemplateInstanceRequirementsNetworkInterfaceCount.Jsii$Proxy.class)
public interface LaunchTemplateInstanceRequirementsNetworkInterfaceCount extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LaunchTemplateInstanceRequirementsNetworkInterfaceCount}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LaunchTemplateInstanceRequirementsNetworkInterfaceCount}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LaunchTemplateInstanceRequirementsNetworkInterfaceCount> {
        java.lang.Number max;
        java.lang.Number min;

        /**
         * Sets the value of {@link LaunchTemplateInstanceRequirementsNetworkInterfaceCount#getMax}
        ...
        /**
         * Sets the value of {@link LaunchTemplateInstanceRequirementsNetworkInterfaceCount#getMin}
         ...
         * @return a new instance of {@link LaunchTemplateInstanceRequirementsNetworkInterfaceCount}
    ...
    /**
     * An implementation for {@link LaunchTemplateInstanceRequirementsNetworkInterfaceCount}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LaunchTemplateInstanceRequirementsNetworkInterfaceCount {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.ec2.LaunchTemplateInstanceRequirementsNetworkInterfaceCount"));
        ...
        public final boolean equals(final Object o) {
            ...
            LaunchTemplateInstanceRequirementsNetworkInterfaceCount.Jsii$Proxy that = (LaunchTemplateInstanceRequirementsNetworkInterfaceCount.Jsii$Proxy) o;
