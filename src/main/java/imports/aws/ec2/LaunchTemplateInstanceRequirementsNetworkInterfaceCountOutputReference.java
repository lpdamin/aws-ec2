...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference")
public class LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.ec2.LaunchTemplateInstanceRequirementsNetworkInterfaceCount getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.LaunchTemplateInstanceRequirementsNetworkInterfaceCount.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.LaunchTemplateInstanceRequirementsNetworkInterfaceCount value) {
