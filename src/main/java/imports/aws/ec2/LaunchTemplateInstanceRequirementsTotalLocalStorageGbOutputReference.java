...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.LaunchTemplateInstanceRequirementsTotalLocalStorageGbOutputReference")
public class LaunchTemplateInstanceRequirementsTotalLocalStorageGbOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.ec2.LaunchTemplateInstanceRequirementsTotalLocalStorageGb getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.LaunchTemplateInstanceRequirementsTotalLocalStorageGb.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.LaunchTemplateInstanceRequirementsTotalLocalStorageGb value) {
