...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:59.204Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.SnapshotCreateVolumePermissionTimeoutsOutputReference")
public class SnapshotCreateVolumePermissionTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected SnapshotCreateVolumePermissionTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SnapshotCreateVolumePermissionTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public SnapshotCreateVolumePermissionTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.SnapshotCreateVolumePermissionTimeouts value) {
