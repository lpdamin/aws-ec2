...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.efs.EfsReplicationConfigurationTimeoutsOutputReference")
public class EfsReplicationConfigurationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EfsReplicationConfigurationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EfsReplicationConfigurationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public EfsReplicationConfigurationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.efs.EfsReplicationConfigurationTimeouts value) {
