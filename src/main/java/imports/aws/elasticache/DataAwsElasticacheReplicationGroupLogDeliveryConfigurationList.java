...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elasticache.DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList")
public class DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.elasticache.DataAwsElasticacheReplicationGroupLogDeliveryConfigurationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.elasticache.DataAwsElasticacheReplicationGroupLogDeliveryConfigurationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
