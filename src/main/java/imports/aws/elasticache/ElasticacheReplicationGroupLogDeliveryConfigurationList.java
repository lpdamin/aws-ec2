...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elasticache.ElasticacheReplicationGroupLogDeliveryConfigurationList")
public class ElasticacheReplicationGroupLogDeliveryConfigurationList extends com.hashicorp.cdktf.ComplexList {

    protected ElasticacheReplicationGroupLogDeliveryConfigurationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ElasticacheReplicationGroupLogDeliveryConfigurationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.elasticache.ElasticacheReplicationGroupLogDeliveryConfigurationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.elasticache.ElasticacheReplicationGroupLogDeliveryConfigurationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.elasticache.ElasticacheReplicationGroupLogDeliveryConfiguration> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
