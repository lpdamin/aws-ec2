...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elasticsearch.DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList")
public class DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.elasticsearch.DataAwsElasticsearchDomainClusterConfigColdStorageOptionsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.elasticsearch.DataAwsElasticsearchDomainClusterConfigColdStorageOptionsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
