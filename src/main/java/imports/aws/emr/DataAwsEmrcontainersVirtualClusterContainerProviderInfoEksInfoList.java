...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList")
public class DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
