...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderInfoList")
public class DataAwsEmrcontainersVirtualClusterContainerProviderInfoList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsEmrcontainersVirtualClusterContainerProviderInfoList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEmrcontainersVirtualClusterContainerProviderInfoList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderInfoOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderInfoOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
