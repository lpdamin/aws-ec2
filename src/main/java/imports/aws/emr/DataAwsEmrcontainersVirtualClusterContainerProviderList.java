...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:16:59.920Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderList")
public class DataAwsEmrcontainersVirtualClusterContainerProviderList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsEmrcontainersVirtualClusterContainerProviderList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEmrcontainersVirtualClusterContainerProviderList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.emr.DataAwsEmrcontainersVirtualClusterContainerProviderOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
