 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:49.170Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.fsx.DataAwsFsxOpenzfsSnapshot")
public class DataAwsFsxOpenzfsSnapshot extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsFsxOpenzfsSnapshot(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsFsxOpenzfsSnapshot(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.fsx.DataAwsFsxOpenzfsSnapshot.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsFsxOpenzfsSnapshot(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.fsx.DataAwsFsxOpenzfsSnapshotConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsFsxOpenzfsSnapshot(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.fsx.DataAwsFsxOpenzfsSnapshotFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.fsx.DataAwsFsxOpenzfsSnapshotFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.fsx.DataAwsFsxOpenzfsSnapshot}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.fsx.DataAwsFsxOpenzfsSnapshot> {
        /**
        ...
        private imports.aws.fsx.DataAwsFsxOpenzfsSnapshotConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.fsx.DataAwsFsxOpenzfsSnapshotFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/fsx_openzfs_snapshot#id DataAwsFsxOpenzfsSnapshot#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param mostRecent Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/fsx_openzfs_snapshot#most_recent DataAwsFsxOpenzfsSnapshot#most_recent}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/fsx_openzfs_snapshot#name DataAwsFsxOpenzfsSnapshot#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param snapshotIds Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/fsx_openzfs_snapshot#snapshot_ids DataAwsFsxOpenzfsSnapshot#snapshot_ids}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/fsx_openzfs_snapshot#tags DataAwsFsxOpenzfsSnapshot#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.fsx.DataAwsFsxOpenzfsSnapshot}.
         */
        @Override
        public imports.aws.fsx.DataAwsFsxOpenzfsSnapshot build() {
            return new imports.aws.fsx.DataAwsFsxOpenzfsSnapshot(
                this.scope,
                this.id,
        ...
        private imports.aws.fsx.DataAwsFsxOpenzfsSnapshotConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.fsx.DataAwsFsxOpenzfsSnapshotConfig.Builder();
            }
            return this.config;
        }
    }
