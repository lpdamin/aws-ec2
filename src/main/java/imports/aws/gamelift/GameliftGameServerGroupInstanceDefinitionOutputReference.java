...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.gamelift.GameliftGameServerGroupInstanceDefinitionOutputReference")
public class GameliftGameServerGroupInstanceDefinitionOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected GameliftGameServerGroupInstanceDefinitionOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GameliftGameServerGroupInstanceDefinitionOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.gamelift.GameliftGameServerGroupInstanceDefinition value) {
