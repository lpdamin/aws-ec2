 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:49.275Z")
...
public class GluePartitionIndex extends com.hashicorp.cdktf.TerraformResource {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.glue.GluePartitionIndexTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.glue.GluePartitionIndexTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GluePartitionIndexTimeoutsOutputReference.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.glue.GluePartitionIndex> {
         ...
         */
        public Builder timeouts(final imports.aws.glue.GluePartitionIndexTimeouts timeouts) {
