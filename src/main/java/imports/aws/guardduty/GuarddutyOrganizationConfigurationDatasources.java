...
public interface GuarddutyOrganizationConfigurationDatasources extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesKubernetes getKubernetes() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesMalwareProtection getMalwareProtection() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<GuarddutyOrganizationConfigurationDatasources> {
        imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesKubernetes kubernetes;
        imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesMalwareProtection malwareProtection;
         ...
         * @return {@code this}
         */
        public Builder kubernetes(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesKubernetes kubernetes) {
         ...
         * @return {@code this}
         */
        public Builder malwareProtection(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesMalwareProtection malwareProtection) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements GuarddutyOrganizationConfigurationDatasources {
        private final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesKubernetes kubernetes;
        private final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesMalwareProtection malwareProtection;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.kubernetes = software.amazon.jsii.Kernel.get(this, "kubernetes", software.amazon.jsii.NativeType.forClass(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesKubernetes.class));
            this.malwareProtection = software.amazon.jsii.Kernel.get(this, "malwareProtection", software.amazon.jsii.NativeType.forClass(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesMalwareProtection.class));
        ...
        @Override
        public final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesKubernetes getKubernetes() {
            return this.kubernetes;
        }

        @Override
        public final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesMalwareProtection getMalwareProtection() {
