 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:00.425Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iam.DataAwsIamInstanceProfiles")
public class DataAwsIamInstanceProfiles extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsIamInstanceProfiles(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsIamInstanceProfiles(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.iam.DataAwsIamInstanceProfiles.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsIamInstanceProfiles(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.iam.DataAwsIamInstanceProfilesConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.iam.DataAwsIamInstanceProfiles}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.iam.DataAwsIamInstanceProfiles> {
        /**
        ...
        private final imports.aws.iam.DataAwsIamInstanceProfilesConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.iam.DataAwsIamInstanceProfilesConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/iam_instance_profiles#id DataAwsIamInstanceProfiles#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.iam.DataAwsIamInstanceProfiles}.
         */
        @Override
        public imports.aws.iam.DataAwsIamInstanceProfiles build() {
            return new imports.aws.iam.DataAwsIamInstanceProfiles(
                this.scope,
                this.id,
                this.config.build()
            );
