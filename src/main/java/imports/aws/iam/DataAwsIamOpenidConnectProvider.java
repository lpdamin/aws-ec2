 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:00.426Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iam.DataAwsIamOpenidConnectProvider")
public class DataAwsIamOpenidConnectProvider extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsIamOpenidConnectProvider(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsIamOpenidConnectProvider(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.iam.DataAwsIamOpenidConnectProvider.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsIamOpenidConnectProvider(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.iam.DataAwsIamOpenidConnectProviderConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsIamOpenidConnectProvider(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    /**
     * A fluent builder for {@link imports.aws.iam.DataAwsIamOpenidConnectProvider}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.iam.DataAwsIamOpenidConnectProvider> {
        /**
        ...
        private imports.aws.iam.DataAwsIamOpenidConnectProviderConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param arn Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/iam_openid_connect_provider#arn DataAwsIamOpenidConnectProvider#arn}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/iam_openid_connect_provider#id DataAwsIamOpenidConnectProvider#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/iam_openid_connect_provider#tags DataAwsIamOpenidConnectProvider#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param url Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/iam_openid_connect_provider#url DataAwsIamOpenidConnectProvider#url}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.iam.DataAwsIamOpenidConnectProvider}.
         */
        @Override
        public imports.aws.iam.DataAwsIamOpenidConnectProvider build() {
            return new imports.aws.iam.DataAwsIamOpenidConnectProvider(
                this.scope,
                this.id,
        ...
        private imports.aws.iam.DataAwsIamOpenidConnectProviderConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.iam.DataAwsIamOpenidConnectProviderConfig.Builder();
            }
            return this.config;
        }
    }
