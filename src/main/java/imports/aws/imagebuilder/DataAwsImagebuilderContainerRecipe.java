 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:49.363Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.imagebuilder.DataAwsImagebuilderContainerRecipe")
public class DataAwsImagebuilderContainerRecipe extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipe.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsImagebuilderContainerRecipe(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeComponentList getComponent() {
        return software.amazon.jsii.Kernel.get(this, "component", software.amazon.jsii.NativeType.forClass(imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeComponentList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeInstanceConfigurationList getInstanceConfiguration() {
        return software.amazon.jsii.Kernel.get(this, "instanceConfiguration", software.amazon.jsii.NativeType.forClass(imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeInstanceConfigurationList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeTargetRepositoryList getTargetRepository() {
        return software.amazon.jsii.Kernel.get(this, "targetRepository", software.amazon.jsii.NativeType.forClass(imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeTargetRepositoryList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipe}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipe> {
        /**
        ...
        private final imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipeConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param arn Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_container_recipe#arn DataAwsImagebuilderContainerRecipe#arn}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_container_recipe#id DataAwsImagebuilderContainerRecipe#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_container_recipe#tags DataAwsImagebuilderContainerRecipe#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipe}.
         */
        @Override
        public imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipe build() {
            return new imports.aws.imagebuilder.DataAwsImagebuilderContainerRecipe(
                this.scope,
                this.id,
                this.config.build()
            );
