...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.imagebuilder.ImagebuilderContainerRecipeTargetRepositoryOutputReference")
public class ImagebuilderContainerRecipeTargetRepositoryOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.imagebuilder.ImagebuilderContainerRecipeTargetRepository getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.imagebuilder.ImagebuilderContainerRecipeTargetRepository.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.imagebuilder.ImagebuilderContainerRecipeTargetRepository value) {
