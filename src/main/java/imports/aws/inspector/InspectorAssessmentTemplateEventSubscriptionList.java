...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:00.547Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.inspector.InspectorAssessmentTemplateEventSubscriptionList")
public class InspectorAssessmentTemplateEventSubscriptionList extends com.hashicorp.cdktf.ComplexList {

    protected InspectorAssessmentTemplateEventSubscriptionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected InspectorAssessmentTemplateEventSubscriptionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public InspectorAssessmentTemplateEventSubscriptionList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.inspector.InspectorAssessmentTemplateEventSubscriptionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.inspector.InspectorAssessmentTemplateEventSubscriptionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.inspector.InspectorAssessmentTemplateEventSubscription> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
