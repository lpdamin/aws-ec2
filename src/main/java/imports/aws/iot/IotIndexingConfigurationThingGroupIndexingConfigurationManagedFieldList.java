...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iot.IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldList")
public class IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldList extends com.hashicorp.cdktf.ComplexList {

    protected IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.iot.IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.iot.IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.iot.IotIndexingConfigurationThingGroupIndexingConfigurationManagedField> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
