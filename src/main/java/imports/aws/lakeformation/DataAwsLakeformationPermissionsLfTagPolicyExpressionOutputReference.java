...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lakeformation.DataAwsLakeformationPermissionsLfTagPolicyExpressionOutputReference")
public class DataAwsLakeformationPermissionsLfTagPolicyExpressionOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsLakeformationPermissionsLfTagPolicyExpressionOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLakeformationPermissionsLfTagPolicyExpressionOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.lakeformation.DataAwsLakeformationPermissionsLfTagPolicyExpression value) {
