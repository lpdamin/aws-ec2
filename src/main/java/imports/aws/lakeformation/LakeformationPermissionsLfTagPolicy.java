...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lakeformation.LakeformationPermissionsLfTagPolicy")
@software.amazon.jsii.Jsii.Proxy(LakeformationPermissionsLfTagPolicy.Jsii$Proxy.class)
public interface LakeformationPermissionsLfTagPolicy extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LakeformationPermissionsLfTagPolicy}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LakeformationPermissionsLfTagPolicy}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LakeformationPermissionsLfTagPolicy> {
        java.lang.Object expression;
        java.lang.String resourceType;
        java.lang.String catalogId;

        /**
         * Sets the value of {@link LakeformationPermissionsLfTagPolicy#getExpression}
         ...
         * @return {@code this}
         */
        public Builder expression(java.util.List<? extends imports.aws.lakeformation.LakeformationPermissionsLfTagPolicyExpression> expression) {
            this.expression = expression;
            return this;
        }

        /**
         * Sets the value of {@link LakeformationPermissionsLfTagPolicy#getResourceType}
         * @param resourceType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lakeformation_permissions#resource_type LakeformationPermissions#resource_type}. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link LakeformationPermissionsLfTagPolicy#getCatalogId}
         ...
         * @return a new instance of {@link LakeformationPermissionsLfTagPolicy}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LakeformationPermissionsLfTagPolicy build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LakeformationPermissionsLfTagPolicy}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LakeformationPermissionsLfTagPolicy {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lakeformation.LakeformationPermissionsLfTagPolicy"));
        ...
        public final boolean equals(final Object o) {
            ...
            LakeformationPermissionsLfTagPolicy.Jsii$Proxy that = (LakeformationPermissionsLfTagPolicy.Jsii$Proxy) o;
