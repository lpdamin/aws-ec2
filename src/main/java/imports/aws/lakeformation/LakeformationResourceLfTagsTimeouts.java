...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lakeformation.LakeformationResourceLfTagsTimeouts")
@software.amazon.jsii.Jsii.Proxy(LakeformationResourceLfTagsTimeouts.Jsii$Proxy.class)
public interface LakeformationResourceLfTagsTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LakeformationResourceLfTagsTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LakeformationResourceLfTagsTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LakeformationResourceLfTagsTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link LakeformationResourceLfTagsTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link LakeformationResourceLfTagsTimeouts#getDelete}
         ...
         * @return a new instance of {@link LakeformationResourceLfTagsTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LakeformationResourceLfTagsTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LakeformationResourceLfTagsTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LakeformationResourceLfTagsTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lakeformation.LakeformationResourceLfTagsTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            LakeformationResourceLfTagsTimeouts.Jsii$Proxy that = (LakeformationResourceLfTagsTimeouts.Jsii$Proxy) o;
