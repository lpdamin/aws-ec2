 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:49.759Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lambdafunction.DataAwsLambdaFunctionUrl")
public class DataAwsLambdaFunctionUrl extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsLambdaFunctionUrl(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLambdaFunctionUrl(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lambdafunction.DataAwsLambdaFunctionUrl.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsLambdaFunctionUrl(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.DataAwsLambdaFunctionUrlConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.DataAwsLambdaFunctionUrlCorsList getCors() {
        return software.amazon.jsii.Kernel.get(this, "cors", software.amazon.jsii.NativeType.forClass(imports.aws.lambdafunction.DataAwsLambdaFunctionUrlCorsList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.lambdafunction.DataAwsLambdaFunctionUrl}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lambdafunction.DataAwsLambdaFunctionUrl> {
        /**
        ...
        private final imports.aws.lambdafunction.DataAwsLambdaFunctionUrlConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lambdafunction.DataAwsLambdaFunctionUrlConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param functionName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_function_url#function_name DataAwsLambdaFunctionUrl#function_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_function_url#id DataAwsLambdaFunctionUrl#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param qualifier Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_function_url#qualifier DataAwsLambdaFunctionUrl#qualifier}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.lambdafunction.DataAwsLambdaFunctionUrl}.
         */
        @Override
        public imports.aws.lambdafunction.DataAwsLambdaFunctionUrl build() {
            return new imports.aws.lambdafunction.DataAwsLambdaFunctionUrl(
                this.scope,
                this.id,
                this.config.build()
            );
