...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lightsail.LightsailContainerServiceDeploymentVersionContainerList")
public class LightsailContainerServiceDeploymentVersionContainerList extends com.hashicorp.cdktf.ComplexList {

    protected LightsailContainerServiceDeploymentVersionContainerList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LightsailContainerServiceDeploymentVersionContainerList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.lightsail.LightsailContainerServiceDeploymentVersionContainerOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.lightsail.LightsailContainerServiceDeploymentVersionContainerOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.lightsail.LightsailContainerServiceDeploymentVersionContainer> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
