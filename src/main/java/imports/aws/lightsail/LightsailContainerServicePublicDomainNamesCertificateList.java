...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lightsail.LightsailContainerServicePublicDomainNamesCertificateList")
public class LightsailContainerServicePublicDomainNamesCertificateList extends com.hashicorp.cdktf.ComplexList {

    protected LightsailContainerServicePublicDomainNamesCertificateList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LightsailContainerServicePublicDomainNamesCertificateList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.lightsail.LightsailContainerServicePublicDomainNamesCertificateOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.lightsail.LightsailContainerServicePublicDomainNamesCertificateOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.lightsail.LightsailContainerServicePublicDomainNamesCertificate> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
