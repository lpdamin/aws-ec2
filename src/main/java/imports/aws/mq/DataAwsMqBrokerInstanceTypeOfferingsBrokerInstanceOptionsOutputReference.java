...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.mq.DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReference")
public class DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.mq.DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZonesList getAvailabilityZones() {
        return software.amazon.jsii.Kernel.get(this, "availabilityZones", software.amazon.jsii.NativeType.forClass(imports.aws.mq.DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZonesList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.mq.DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptions getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.mq.DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptions.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.mq.DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptions value) {
