...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.msk.MskconnectConnectorKafkaClusterApacheKafkaClusterVpc")
@software.amazon.jsii.Jsii.Proxy(MskconnectConnectorKafkaClusterApacheKafkaClusterVpc.Jsii$Proxy.class)
public interface MskconnectConnectorKafkaClusterApacheKafkaClusterVpc extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link MskconnectConnectorKafkaClusterApacheKafkaClusterVpc}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link MskconnectConnectorKafkaClusterApacheKafkaClusterVpc}
     */
    public static final class Builder implements software.amazon.jsii.Builder<MskconnectConnectorKafkaClusterApacheKafkaClusterVpc> {
        ...
        /**
         * Sets the value of {@link MskconnectConnectorKafkaClusterApacheKafkaClusterVpc#getSecurityGroups}
         * @param securityGroups Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/mskconnect_connector#security_groups MskconnectConnector#security_groups}. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link MskconnectConnectorKafkaClusterApacheKafkaClusterVpc#getSubnets}
         * @param subnets Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/mskconnect_connector#subnets MskconnectConnector#subnets}. This parameter is required.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link MskconnectConnectorKafkaClusterApacheKafkaClusterVpc}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public MskconnectConnectorKafkaClusterApacheKafkaClusterVpc build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link MskconnectConnectorKafkaClusterApacheKafkaClusterVpc}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MskconnectConnectorKafkaClusterApacheKafkaClusterVpc {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.msk.MskconnectConnectorKafkaClusterApacheKafkaClusterVpc"));
        ...
        public final boolean equals(final Object o) {
            ...
            MskconnectConnectorKafkaClusterApacheKafkaClusterVpc.Jsii$Proxy that = (MskconnectConnectorKafkaClusterApacheKafkaClusterVpc.Jsii$Proxy) o;
