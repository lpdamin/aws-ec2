...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:00.878Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.msk.MskconnectConnectorWorkerConfiguration")
@software.amazon.jsii.Jsii.Proxy(MskconnectConnectorWorkerConfiguration.Jsii$Proxy.class)
public interface MskconnectConnectorWorkerConfiguration extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link MskconnectConnectorWorkerConfiguration}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link MskconnectConnectorWorkerConfiguration}
     */
    public static final class Builder implements software.amazon.jsii.Builder<MskconnectConnectorWorkerConfiguration> {
        java.lang.String arn;
        java.lang.Number revision;

        /**
         * Sets the value of {@link MskconnectConnectorWorkerConfiguration#getArn}
        ...
        /**
         * Sets the value of {@link MskconnectConnectorWorkerConfiguration#getRevision}
         ...
         * @return a new instance of {@link MskconnectConnectorWorkerConfiguration}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public MskconnectConnectorWorkerConfiguration build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link MskconnectConnectorWorkerConfiguration}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MskconnectConnectorWorkerConfiguration {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.msk.MskconnectConnectorWorkerConfiguration"));
        ...
        public final boolean equals(final Object o) {
            ...
            MskconnectConnectorWorkerConfiguration.Jsii$Proxy that = (MskconnectConnectorWorkerConfiguration.Jsii$Proxy) o;
