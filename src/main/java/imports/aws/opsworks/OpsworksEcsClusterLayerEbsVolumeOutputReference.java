...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksEcsClusterLayerEbsVolumeOutputReference")
public class OpsworksEcsClusterLayerEbsVolumeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksEcsClusterLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksEcsClusterLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksEcsClusterLayerEbsVolume value) {
