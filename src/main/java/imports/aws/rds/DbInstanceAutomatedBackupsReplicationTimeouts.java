...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.rds.DbInstanceAutomatedBackupsReplicationTimeouts")
@software.amazon.jsii.Jsii.Proxy(DbInstanceAutomatedBackupsReplicationTimeouts.Jsii$Proxy.class)
public interface DbInstanceAutomatedBackupsReplicationTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DbInstanceAutomatedBackupsReplicationTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DbInstanceAutomatedBackupsReplicationTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DbInstanceAutomatedBackupsReplicationTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DbInstanceAutomatedBackupsReplicationTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DbInstanceAutomatedBackupsReplicationTimeouts#getDelete}
         ...
         * @return a new instance of {@link DbInstanceAutomatedBackupsReplicationTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DbInstanceAutomatedBackupsReplicationTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DbInstanceAutomatedBackupsReplicationTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DbInstanceAutomatedBackupsReplicationTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.rds.DbInstanceAutomatedBackupsReplicationTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DbInstanceAutomatedBackupsReplicationTimeouts.Jsii$Proxy that = (DbInstanceAutomatedBackupsReplicationTimeouts.Jsii$Proxy) o;
