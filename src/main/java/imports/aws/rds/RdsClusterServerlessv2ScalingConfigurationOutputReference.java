...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.rds.RdsClusterServerlessv2ScalingConfigurationOutputReference")
public class RdsClusterServerlessv2ScalingConfigurationOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.rds.RdsClusterServerlessv2ScalingConfiguration getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.rds.RdsClusterServerlessv2ScalingConfiguration.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.rds.RdsClusterServerlessv2ScalingConfiguration value) {
