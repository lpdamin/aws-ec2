...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.redshift.RedshiftEndpointAccess")
public class RedshiftEndpointAccess extends com.hashicorp.cdktf.TerraformResource {

    protected RedshiftEndpointAccess(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RedshiftEndpointAccess(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.redshift.RedshiftEndpointAccess.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RedshiftEndpointAccess(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.redshift.RedshiftEndpointAccessConfig config) {
    ...
    public void resetResourceOwner() {
        software.amazon.jsii.Kernel.call(this, "resetResourceOwner", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.redshift.RedshiftEndpointAccessVpcEndpointList getVpcEndpoint() {
        return software.amazon.jsii.Kernel.get(this, "vpcEndpoint", software.amazon.jsii.NativeType.forClass(imports.aws.redshift.RedshiftEndpointAccessVpcEndpointList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.redshift.RedshiftEndpointAccess}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.redshift.RedshiftEndpointAccess> {
        /**
        ...
        private final imports.aws.redshift.RedshiftEndpointAccessConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.redshift.RedshiftEndpointAccessConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/redshift_endpoint_access#id RedshiftEndpointAccess#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param resourceOwner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/redshift_endpoint_access#resource_owner RedshiftEndpointAccess#resource_owner}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param vpcSecurityGroupIds Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/redshift_endpoint_access#vpc_security_group_ids RedshiftEndpointAccess#vpc_security_group_ids}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.redshift.RedshiftEndpointAccess}.
         */
        @Override
        public imports.aws.redshift.RedshiftEndpointAccess build() {
            return new imports.aws.redshift.RedshiftEndpointAccess(
                this.scope,
                this.id,
                this.config.build()
            );
