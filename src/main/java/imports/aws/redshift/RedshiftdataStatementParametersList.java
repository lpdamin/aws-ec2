...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.redshift.RedshiftdataStatementParametersList")
public class RedshiftdataStatementParametersList extends com.hashicorp.cdktf.ComplexList {

    protected RedshiftdataStatementParametersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RedshiftdataStatementParametersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public RedshiftdataStatementParametersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.redshift.RedshiftdataStatementParametersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.redshift.RedshiftdataStatementParametersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.redshift.RedshiftdataStatementParameters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
