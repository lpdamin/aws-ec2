...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocationList")
public class DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocationList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.route53.DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.route53.DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.route53.DataAwsRoute53TrafficPolicyDocumentRuleGeoProximityLocation> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
