...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.Route53DomainsRegisteredDomainTimeouts")
@software.amazon.jsii.Jsii.Proxy(Route53DomainsRegisteredDomainTimeouts.Jsii$Proxy.class)
public interface Route53DomainsRegisteredDomainTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link Route53DomainsRegisteredDomainTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link Route53DomainsRegisteredDomainTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<Route53DomainsRegisteredDomainTimeouts> {
        java.lang.String create;
        java.lang.String update;

        /**
         * Sets the value of {@link Route53DomainsRegisteredDomainTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link Route53DomainsRegisteredDomainTimeouts#getUpdate}
         ...
         * @return a new instance of {@link Route53DomainsRegisteredDomainTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public Route53DomainsRegisteredDomainTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link Route53DomainsRegisteredDomainTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Route53DomainsRegisteredDomainTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.route53.Route53DomainsRegisteredDomainTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            Route53DomainsRegisteredDomainTimeouts.Jsii$Proxy that = (Route53DomainsRegisteredDomainTimeouts.Jsii$Proxy) o;
