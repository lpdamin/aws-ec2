...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicecatalog.ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference")
public class ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.servicecatalog.ServicecatalogTagOptionResourceAssociationTimeouts value) {
