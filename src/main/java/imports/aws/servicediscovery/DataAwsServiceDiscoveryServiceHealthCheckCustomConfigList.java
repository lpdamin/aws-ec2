...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicediscovery.DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList")
public class DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.servicediscovery.DataAwsServiceDiscoveryServiceHealthCheckCustomConfigOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.servicediscovery.DataAwsServiceDiscoveryServiceHealthCheckCustomConfigOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
