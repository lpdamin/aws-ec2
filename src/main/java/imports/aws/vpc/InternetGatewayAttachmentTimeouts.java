...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:50.935Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.InternetGatewayAttachmentTimeouts")
@software.amazon.jsii.Jsii.Proxy(InternetGatewayAttachmentTimeouts.Jsii$Proxy.class)
public interface InternetGatewayAttachmentTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link InternetGatewayAttachmentTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link InternetGatewayAttachmentTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<InternetGatewayAttachmentTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link InternetGatewayAttachmentTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link InternetGatewayAttachmentTimeouts#getDelete}
         ...
         * @return a new instance of {@link InternetGatewayAttachmentTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public InternetGatewayAttachmentTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link InternetGatewayAttachmentTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements InternetGatewayAttachmentTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.InternetGatewayAttachmentTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            InternetGatewayAttachmentTimeouts.Jsii$Proxy that = (InternetGatewayAttachmentTimeouts.Jsii$Proxy) o;
