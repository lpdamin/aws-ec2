...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.InternetGatewayAttachmentTimeoutsOutputReference")
public class InternetGatewayAttachmentTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected InternetGatewayAttachmentTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected InternetGatewayAttachmentTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public InternetGatewayAttachmentTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.InternetGatewayAttachmentTimeouts value) {
