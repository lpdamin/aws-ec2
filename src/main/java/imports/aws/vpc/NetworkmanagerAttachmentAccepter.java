...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerAttachmentAccepter")
public class NetworkmanagerAttachmentAccepter extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.NetworkmanagerAttachmentAccepter.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public NetworkmanagerAttachmentAccepter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerAttachmentAccepterConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerAttachmentAccepterTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerAttachmentAccepterTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.NetworkmanagerAttachmentAccepterTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.NetworkmanagerAttachmentAccepter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.NetworkmanagerAttachmentAccepter> {
        /**
        ...
        private final imports.aws.vpc.NetworkmanagerAttachmentAccepterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.NetworkmanagerAttachmentAccepterConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/networkmanager_attachment_accepter#id NetworkmanagerAttachmentAccepter#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.vpc.NetworkmanagerAttachmentAccepterTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.vpc.NetworkmanagerAttachmentAccepter}.
         */
        @Override
        public imports.aws.vpc.NetworkmanagerAttachmentAccepter build() {
            return new imports.aws.vpc.NetworkmanagerAttachmentAccepter(
                this.scope,
                this.id,
                this.config.build()
            );
