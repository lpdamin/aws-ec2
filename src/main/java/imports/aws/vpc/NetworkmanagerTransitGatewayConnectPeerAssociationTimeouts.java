...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:01.982Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts")
@software.amazon.jsii.Jsii.Proxy(NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts.Jsii$Proxy.class)
public interface NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts#getDelete}
         ...
         * @return a new instance of {@link NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts.Jsii$Proxy that = (NetworkmanagerTransitGatewayConnectPeerAssociationTimeouts.Jsii$Proxy) o;
