...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerTransitGatewayPeeringTimeouts")
@software.amazon.jsii.Jsii.Proxy(NetworkmanagerTransitGatewayPeeringTimeouts.Jsii$Proxy.class)
public interface NetworkmanagerTransitGatewayPeeringTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkmanagerTransitGatewayPeeringTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkmanagerTransitGatewayPeeringTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkmanagerTransitGatewayPeeringTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayPeeringTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayPeeringTimeouts#getDelete}
         ...
         * @return a new instance of {@link NetworkmanagerTransitGatewayPeeringTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkmanagerTransitGatewayPeeringTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkmanagerTransitGatewayPeeringTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkmanagerTransitGatewayPeeringTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.NetworkmanagerTransitGatewayPeeringTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkmanagerTransitGatewayPeeringTimeouts.Jsii$Proxy that = (NetworkmanagerTransitGatewayPeeringTimeouts.Jsii$Proxy) o;
