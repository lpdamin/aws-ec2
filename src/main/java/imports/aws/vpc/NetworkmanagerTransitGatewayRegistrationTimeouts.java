...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:50.970Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerTransitGatewayRegistrationTimeouts")
@software.amazon.jsii.Jsii.Proxy(NetworkmanagerTransitGatewayRegistrationTimeouts.Jsii$Proxy.class)
public interface NetworkmanagerTransitGatewayRegistrationTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkmanagerTransitGatewayRegistrationTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkmanagerTransitGatewayRegistrationTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkmanagerTransitGatewayRegistrationTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayRegistrationTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayRegistrationTimeouts#getDelete}
         ...
         * @return a new instance of {@link NetworkmanagerTransitGatewayRegistrationTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkmanagerTransitGatewayRegistrationTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkmanagerTransitGatewayRegistrationTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkmanagerTransitGatewayRegistrationTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.NetworkmanagerTransitGatewayRegistrationTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkmanagerTransitGatewayRegistrationTimeouts.Jsii$Proxy that = (NetworkmanagerTransitGatewayRegistrationTimeouts.Jsii$Proxy) o;
