...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts")
@software.amazon.jsii.Jsii.Proxy(NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts.Jsii$Proxy.class)
public interface NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts#getDelete}
         ...
         * @return a new instance of {@link NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts.Jsii$Proxy that = (NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts.Jsii$Proxy) o;
