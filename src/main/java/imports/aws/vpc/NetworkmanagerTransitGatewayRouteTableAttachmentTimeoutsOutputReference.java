...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsOutputReference")
public class NetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected NetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public NetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.NetworkmanagerTransitGatewayRouteTableAttachmentTimeouts value) {
