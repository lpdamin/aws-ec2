 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:01.998Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerVpcAttachment")
public class NetworkmanagerVpcAttachment extends com.hashicorp.cdktf.TerraformResource {

    protected NetworkmanagerVpcAttachment(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkmanagerVpcAttachment(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.NetworkmanagerVpcAttachment.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public NetworkmanagerVpcAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerVpcAttachmentConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putOptions(final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerVpcAttachmentOptions value) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerVpcAttachmentTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerVpcAttachmentOptionsOutputReference getOptions() {
        return software.amazon.jsii.Kernel.get(this, "options", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.NetworkmanagerVpcAttachmentOptionsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkmanagerVpcAttachmentTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.NetworkmanagerVpcAttachmentTimeoutsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.vpc.NetworkmanagerVpcAttachmentOptions getOptionsInput() {
        return software.amazon.jsii.Kernel.get(this, "optionsInput", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.NetworkmanagerVpcAttachmentOptions.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getVpcArnInput() {
        return software.amazon.jsii.Kernel.get(this, "vpcArnInput", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.NetworkmanagerVpcAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.NetworkmanagerVpcAttachment> {
        /**
        ...
        private final imports.aws.vpc.NetworkmanagerVpcAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.NetworkmanagerVpcAttachmentConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/networkmanager_vpc_attachment#id NetworkmanagerVpcAttachment#id}. This parameter is required.
         */
         ...
         */
        public Builder options(final imports.aws.vpc.NetworkmanagerVpcAttachmentOptions options) {
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/networkmanager_vpc_attachment#tags NetworkmanagerVpcAttachment#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/networkmanager_vpc_attachment#tags_all NetworkmanagerVpcAttachment#tags_all}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.vpc.NetworkmanagerVpcAttachmentTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.vpc.NetworkmanagerVpcAttachment}.
         */
        @Override
        public imports.aws.vpc.NetworkmanagerVpcAttachment build() {
            return new imports.aws.vpc.NetworkmanagerVpcAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
