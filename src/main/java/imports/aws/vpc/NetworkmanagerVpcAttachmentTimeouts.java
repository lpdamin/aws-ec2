...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkmanagerVpcAttachmentTimeouts")
@software.amazon.jsii.Jsii.Proxy(NetworkmanagerVpcAttachmentTimeouts.Jsii$Proxy.class)
public interface NetworkmanagerVpcAttachmentTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkmanagerVpcAttachmentTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkmanagerVpcAttachmentTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkmanagerVpcAttachmentTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link NetworkmanagerVpcAttachmentTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link NetworkmanagerVpcAttachmentTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link NetworkmanagerVpcAttachmentTimeouts#getUpdate}
         ...
         * @return a new instance of {@link NetworkmanagerVpcAttachmentTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkmanagerVpcAttachmentTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkmanagerVpcAttachmentTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkmanagerVpcAttachmentTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.NetworkmanagerVpcAttachmentTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkmanagerVpcAttachmentTimeouts.Jsii$Proxy that = (NetworkmanagerVpcAttachmentTimeouts.Jsii$Proxy) o;
