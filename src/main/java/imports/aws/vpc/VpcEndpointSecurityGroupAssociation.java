 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-29T06:16:51.004Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcEndpointSecurityGroupAssociation")
public class VpcEndpointSecurityGroupAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.VpcEndpointSecurityGroupAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public VpcEndpointSecurityGroupAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.VpcEndpointSecurityGroupAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.VpcEndpointSecurityGroupAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.VpcEndpointSecurityGroupAssociation> {
        /**
        ...
        private final imports.aws.vpc.VpcEndpointSecurityGroupAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.VpcEndpointSecurityGroupAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_endpoint_security_group_association#id VpcEndpointSecurityGroupAssociation#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param replaceDefaultAssociation Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_endpoint_security_group_association#replace_default_association VpcEndpointSecurityGroupAssociation#replace_default_association}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.VpcEndpointSecurityGroupAssociation}.
         */
        @Override
        public imports.aws.vpc.VpcEndpointSecurityGroupAssociation build() {
            return new imports.aws.vpc.VpcEndpointSecurityGroupAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
