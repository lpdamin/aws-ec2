...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-28T06:17:02.052Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcPeeringConnectionAccepterTimeouts")
@software.amazon.jsii.Jsii.Proxy(VpcPeeringConnectionAccepterTimeouts.Jsii$Proxy.class)
public interface VpcPeeringConnectionAccepterTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link VpcPeeringConnectionAccepterTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link VpcPeeringConnectionAccepterTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<VpcPeeringConnectionAccepterTimeouts> {
        java.lang.String create;
        java.lang.String update;

        /**
         * Sets the value of {@link VpcPeeringConnectionAccepterTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link VpcPeeringConnectionAccepterTimeouts#getUpdate}
         ...
         * @return a new instance of {@link VpcPeeringConnectionAccepterTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public VpcPeeringConnectionAccepterTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link VpcPeeringConnectionAccepterTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VpcPeeringConnectionAccepterTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.VpcPeeringConnectionAccepterTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            VpcPeeringConnectionAccepterTimeouts.Jsii$Proxy that = (VpcPeeringConnectionAccepterTimeouts.Jsii$Proxy) o;
